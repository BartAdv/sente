...
#+cljs (defn chsk-connect!              [chsk] (-chsk-connect!    chsk))
#+cljs (defn chsk-destroy! "Deprecated" [chsk] (-chsk-disconnect! chsk false))
#+cljs (defn chsk-disconnect!           [chsk] (-chsk-disconnect! chsk false))
#+cljs
